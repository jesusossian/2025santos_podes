...
def main():
	...
	rf_obj1, rf_xp_sol1, rf_xr_sol1, rf_wp_sol1, rf_wr_sol1, rf_vor_sol, rf_yp_sol1, rf_yr_sol1, \
		rf_bestbound1, rf_numnode1, rf_gap1, rf_elapsed1 = rf_obj, rf_xp_sol, rf_xr_sol, rf_wp_sol, \
			rf_wr_sol, rf_vor_sol, rf_yp_sol, rf_yr_sol, rf_bestbound, rf_numnode, rf_gap, rf_elapsed 
	...
	if USE_FOP == True:
		...
		for conj in subset:
			rf_obj, rf_xp_sol, rf_xr_sol, rf_wp_sol, rf_wr_sol, rf_vor_sol, rf_yp_sol, rf_yr_sol, \
				rf_bestbound, rf_numnode, rf_gap, rf_elapsed = fop.fix_and_optimize(conj, rf_yp_sol, rf_yr_sol, \
					N, PP, PR, FP, FR, HR, HP, D, R, SD, SR, C, rf_xp_sol, rf_xr_sol, rf_wp_sol, rf_wr_sol, rf_vor_sol)
